...
import InterviewCard from '../dashboard/_components/InterviewCard.jsx';
    ...
    return(
        <div className="my-5">
            ...
            { interviewList?.length === 0 &&
                <Link href='dashboard/create-interview' className="mt-4 bg-white border border-gray-200 rounded-lg p-5 flex flex-col gap-3 items-center">

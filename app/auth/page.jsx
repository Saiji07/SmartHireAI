...
import { createBrowserClient } from '@supabase/ssr'; // 1. Import the correct function
...
export default function Login() {
    ...
    // 2. Create a new browser client instance
    ...
    const signInWithGoogle = async () => {
        await supabase.auth.signInWithOAuth({
            provider: 'google',
            options: {
                // 3. The callback will handle the final redirect, so this is simpler
